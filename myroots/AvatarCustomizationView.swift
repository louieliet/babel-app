...
struct AvatarCustomizationView: View {
    ...
    @State private var selectedSkinTone = 0
                    ...
                    VStack(spacing: 32) {
                        ...
                        VStack(spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                TextField("Ej: Alex, Sam, Charlie...", text: $avatarName)
                                    ...
                                    CustomizationItem(
                                        ...
                                        view: AnyView(
                                            Circle()
                                                ...
                                                .overlay(
                                                    Circle()
                                                        .stroke(Color.babelPrimary, lineWidth: selectedSkinTone == index ? 3 : 0)
                                                )
                                        )
                                    )
                                },
                                ...
                                items: hairStyles.enumerated().map { index, style in
                                    CustomizationItem(
                                        ...
                                        view: AnyView(
                                            ...
                                            .overlay(
                                                Circle()
                                                    .stroke(Color.babelPrimary, lineWidth: selectedHairStyle == index ? 3 : 0)
                                            )
                                        )
                                    )
                                },
                                ...
                                items: accessories.enumerated().map { index, accessory in
                                    CustomizationItem(
                                        ...
                                        view: AnyView(
                                            ...
                                            .overlay(
                                                Circle()
                                                    .stroke(Color.babelPrimary, lineWidth: selectedAccessory == index ? 3 : 0)
                                            )
                                        )
                                    )
                                },
